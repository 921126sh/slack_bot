...
This module demonstrates simple uses of Botkit's `hears` handler s.
...
export default (controller: SlackController) => {
    ...
    controller.hears(['^uptime','^debug'], 'direct_message,direct_mention', (bot, message: any) => {
    ...
    controller.hears(['^say (.*)','^say'], 'direct_message,direct_mention', (bot, message: any) => {
        if (message.match[1]) {
