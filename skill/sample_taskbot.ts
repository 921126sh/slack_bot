...
export default (controller: SlackController) => {
    ...
    controller.hears(['tasks','todo'], 'direct_message', function(bot, message: any) {

        // load user from storage...
        controller.storage.users.get(message.user, function(err, user: any) {
    ...
    controller.hears(['add (.*)'],'direct_message,direct_mention,mention', function(bot, message: any) {
        ...
        controller.storage.users.get(message.user, function(err, user: any) {
            ...
            controller.storage.users.save(user, function(err,saved) {
                ...
                if (err) {
                    ...
                    bot.api.reactions.add({name: 'thumbsup', channel: message.channel, timestamp: message.ts }, (err, {}) => console.log(err));
                }
    ...
    controller.hears(['done (.*)'],'direct_message', function(bot, message: any) {
    ...
    function generateTaskList(user: any) {
